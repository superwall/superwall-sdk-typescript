...
describe('resource testMode', () => {
  ...
  test.skip('update: only required params', async () => {
    const responsePromise = client.users.testMode.update('app_user_id', { application_id: 'application_id', test_mode_enabled: true });
  ...
  test.skip('update: required and optional params', async () => {
    const response = await client.users.testMode.update('app_user_id', { application_id: 'application_id', test_mode_enabled: true });
  });
