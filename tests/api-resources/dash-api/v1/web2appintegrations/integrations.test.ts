...
describe('resource integrations', () => {
  ...
  test.skip('get: only required params', async () => {
    const responsePromise = client.dashAPI.v1.web2appintegrations.integrations.get('integrationId', {
      projectId: 'projectId',
    });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
  ...
  test.skip('get: required and optional params', async () => {
    const response = await client.dashAPI.v1.web2appintegrations.integrations.get('integrationId', {
      projectId: 'projectId',
    });
  });
});
