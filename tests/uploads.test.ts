import fs from 'fs';
import type { ResponseLike } from 'superwall-api/internal/to-file';
import { toFile } from 'superwall-api/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('superwall-api/core/uploads');
    await expect(
