...
- <code><a href="./src/resources/dash-api/v1/users.ts">UserGetSelfResponse</a></code>

Methods:

- <code title="get /dash-api/v1/users/self">client.dashAPI.v1.users.<a href="./src/resources/dash-api/v1/users.ts">getSelf</a>() -> UserGetSelfResponse</code>
...
- <code><a href="./src/resources/dash-api/v1/applications/campaigns/legacy.ts">LegacyGetStatsResponse</a></code>

Methods:

- <code title="get /dash-api/v1/applications/{applicationId}/campaigns/legacy/statistics">client.dashAPI.v1.applications.campaigns.legacy.<a href="./src/resources/dash-api/v1/applications/campaigns/legacy.ts">getStats</a>(applicationID, { ...params }) -> LegacyGetStatsResponse</code>

#### Legacy

Types:

- <code><a href="./src/resources/dash-api/v1/applications/legacy.ts">LegacyGetRecentTransactionsResponse</a></code>
- <code><a href="./src/resources/dash-api/v1/applications/legacy.ts">LegacyGetStatsResponse</a></code>

Methods:

- <code title="get /dash-api/v1/applications/{applicationId}/legacy/transactions">client.dashAPI.v1.applications.legacy.<a href="./src/resources/dash-api/v1/applications/legacy.ts">getRecentTransactions</a>(applicationID, { ...params }) -> LegacyGetRecentTransactionsResponse</code>
- <code title="get /dash-api/v1/applications/{applicationId}/legacy/statistics">client.dashAPI.v1.applications.legacy.<a href="./src/resources/dash-api/v1/applications/legacy.ts">getStats</a>(applicationID, { ...params }) -> LegacyGetStatsResponse</code>

### Client

Types:

- <code><a href="./src/resources/dash-api/v1/client/client.ts">ClientGetMetaResponse</a></code>

Methods:

- <code title="get /dash-api/v1/client/meta">client.dashAPI.v1.client.<a href="./src/resources/dash-api/v1/client/client.ts">getMeta</a>({ ...params }) -> ClientGetMetaResponse</code>

#### Subscriptions

Types:

- <code><a href="./src/resources/dash-api/v1/client/subscriptions.ts">SubscriptionGetResponse</a></code>
...
- <code title="get /dash-api/v1/client/{playerId}/subscriptions">client.dashAPI.v1.client.subscriptions.<a href="./src/resources/dash-api/v1/client/subscriptions.ts">get</a>(playerID) -> SubscriptionGetResponse</code>
...
- <code><a href="./src/resources/dash-api/v1/paywalls.ts">PaywallListResponse</a></code>
...
- <code title="get /dash-api/v1/paywalls/{applicationId}">client.dashAPI.v1.paywalls.<a href="./src/resources/dash-api/v1/paywalls.ts">list</a>(applicationID, { ...params }) -> PaywallListResponse</code>
...
- <code><a href="./src/resources/dash-api/v1/webpaywalls/webpaywalls.ts">WebpaywallGetConfigurationResponse</a></code>

Methods:

- <code title="get /dash-api/v1/webpaywalls/configuration">client.dashAPI.v1.webpaywalls.<a href="./src/resources/dash-api/v1/webpaywalls/webpaywalls.ts">getConfiguration</a>() -> WebpaywallGetConfigurationResponse</code>
...
- <code><a href="./src/resources/dash-api/v1/webpaywalls/domains.ts">DomainCheckAvailabilityResponse</a></code>
...
- <code title="post /dash-api/v1/webpaywalls/{applicationId}/domains">client.dashAPI.v1.webpaywalls.domains.<a href="./src/resources/dash-api/v1/webpaywalls/domains.ts">add</a>(applicationID, { ...params }) -> WebPaywallDomainModel</code>
- <code title="get /dash-api/v1/webpaywalls/{applicationId}/domains/{domain}">client.dashAPI.v1.webpaywalls.domains.<a href="./src/resources/dash-api/v1/webpaywalls/domains.ts">checkAvailability</a>(domain, { ...params }) -> DomainCheckAvailabilityResponse</code>
...
- <code title="get /dash-api/v1/web2appintegrations/{projectId}/integrations/{integrationId}">client.dashAPI.v1.web2appintegrations.integrations.<a href="./src/resources/dash-api/v1/web2appintegrations/integrations.ts">get</a>(integrationID, { ...params }) -> Web2appIntegrationModel</code>

### Blog

Types:

- <code><a href="./src/resources/dash-api/v1/blog.ts">BlogGetPostBySlugResponse</a></code>

Methods:

- <code title="get /dash-api/v1/blog/posts/{postSlug}">client.dashAPI.v1.blog.<a href="./src/resources/dash-api/v1/blog.ts">getPostBySlug</a>(postSlug) -> BlogGetPostBySlugResponse</code>
...
- <code><a href="./src/resources/dash-api/v1/charts/statistics.ts">StatisticGetConfigResponse</a></code>

Methods:

- <code title="get /dash-api/v1/charts/statistics/config">client.dashAPI.v1.charts.statistics.<a href="./src/resources/dash-api/v1/charts/statistics.ts">getConfig</a>() -> StatisticGetConfigResponse</code>

### Campaigns

Types:

- <code><a href="./src/resources/dash-api/v1/campaigns.ts">CampaignTriggerResponse</a></code>

Methods:

- <code title="post /dash-api/v1/campaigns/{experimentGroupId}/triggers">client.dashAPI.v1.campaigns.<a href="./src/resources/dash-api/v1/campaigns.ts">trigger</a>(experimentGroupID, { ...params }) -> unknown</code>
...
- <code><a href="./src/resources/dash-api/v1/projects/webhooks/webhooks.ts">WebhookCreateManagementPortalResponse</a></code>
- <code><a href="./src/resources/dash-api/v1/projects/webhooks/webhooks.ts">WebhookGetResponse</a></code>
- <code><a href="./src/resources/dash-api/v1/projects/webhooks/webhooks.ts">WebhookGetStatsResponse</a></code>
- <code><a href="./src/resources/dash-api/v1/projects/webhooks/webhooks.ts">WebhookListAttemptsResponse</a></code>
...
- <code title="post /dash-api/v1/projects/{projectId}/webhooks/manage">client.dashAPI.v1.projects.webhooks.<a href="./src/resources/dash-api/v1/projects/webhooks/webhooks.ts">createManagementPortal</a>(projectID) -> WebhookCreateManagementPortalResponse</code>
- <code title="get /dash-api/v1/projects/{projectId}/webhooks/{endpointId}">client.dashAPI.v1.projects.webhooks.<a href="./src/resources/dash-api/v1/projects/webhooks/webhooks.ts">get</a>(endpointID, { ...params }) -> WebhookGetResponse</code>
- <code title="get /dash-api/v1/projects/{projectId}/webhooks/{endpointId}/stats">client.dashAPI.v1.projects.webhooks.<a href="./src/resources/dash-api/v1/projects/webhooks/webhooks.ts">getStats</a>(endpointID, { ...params }) -> WebhookGetStatsResponse</code>
- <code title="get /dash-api/v1/projects/{projectId}/webhooks/{endpointId}/attempts">client.dashAPI.v1.projects.webhooks.<a href="./src/resources/dash-api/v1/projects/webhooks/webhooks.ts">listAttempts</a>(endpointID, { ...params }) -> WebhookListAttemptsResponse</code>
...
- <code><a href="./src/resources/dash-api/v1/projects/webhooks/messages.ts">MessageListAttemptsResponse</a></code>
...
- <code title="get /dash-api/v1/projects/{projectId}/webhooks/messages/{messageId}/attempts">client.dashAPI.v1.projects.webhooks.messages.<a href="./src/resources/dash-api/v1/projects/webhooks/messages.ts">listAttempts</a>(messageID, { ...params }) -> MessageListAttemptsResponse</code>
...
- <code><a href="./src/resources/dash-api/v1/ops/error.ts">ErrorReportAuthenticatedResponse</a></code>
- <code><a href="./src/resources/dash-api/v1/ops/error.ts">ErrorReportUnauthenticatedResponse</a></code>

Methods:

- <code title="post /dash-api/v1/ops/error">client.dashAPI.v1.ops.error.<a href="./src/resources/dash-api/v1/ops/error.ts">reportAuthenticated</a>({ ...params }) -> ErrorReportAuthenticatedResponse</code>
- <code title="post /dash-api/v1/ops/error/unauthenticated">client.dashAPI.v1.ops.error.<a href="./src/resources/dash-api/v1/ops/error.ts">reportUnauthenticated</a>({ ...params }) -> ErrorReportUnauthenticatedResponse</code>
