...
export class Applications extends APIResource {
  ...
  create(
    ...
    return this._client.post(path`/dash-api/v2/projects/${id}/applications`, { body, ...options });
  }
  ...
  update(
    ...
    return this._client.patch(path`/dash-api/v2/projects/${id}/applications/${applicationID}`, {
      body,
      ...options,
    });
  }
  ...
  retrieveRecentTransactions(
    applicationID: string,
    params: ApplicationRetrieveRecentTransactionsParams,
    options?: RequestOptions,
  ): APIPromise<ApplicationRetrieveRecentTransactionsResponse> {
    const { id, ...query } = params;
    return this._client.get(
      path`/dash-api/v2/projects/${id}/applications/${applicationID}/recent-transactions`,
      { query, ...options },
    );
  }
  ...
  retrieveStatistics(
    applicationID: string,
    params: ApplicationRetrieveStatisticsParams,
    options?: RequestOptions,
  ): APIPromise<ApplicationRetrieveStatisticsResponse> {
    const { id, ...query } = params;
    return this._client.get(path`/dash-api/v2/projects/${id}/applications/${applicationID}/statistics`, {
      query,
      ...options,
    });
  }
  ...
  updateSettings(
    ...
    const { id, ...body } = params;
    return this._client.patch(path`/dash-api/v2/projects/${id}/applications/${applicationID}/settings`, {
      body,
      ...options,
    });
  }
...
export interface ApplicationRetrieveRecentTransactionsResponse {
  data: Array<ApplicationRetrieveRecentTransactionsResponse.Data>;

  object: 'list';
}

export namespace ApplicationRetrieveRecentTransactionsResponse {
...
export interface ApplicationRetrieveStatisticsResponse {
  ...
  params: ApplicationRetrieveStatisticsResponse.Params;

  statistics: Array<ApplicationRetrieveStatisticsResponse.Statistic>;
}
...
export interface ApplicationRetrieveRecentTransactionsParams {
  /**
   * Path param: Project ID
   */
  id: string;
...
export interface ApplicationRetrieveStatisticsParams {
  /**
   * Path param: Project ID
   */
  id: string;
...
export declare namespace Applications {
  export {
    ...
    type ApplicationRetrieveRecentTransactionsResponse as ApplicationRetrieveRecentTransactionsResponse,
    ...
    type ApplicationRetrieveRecentTransactionsParams as ApplicationRetrieveRecentTransactionsParams,
    type ApplicationRetrieveStatisticsParams as ApplicationRetrieveStatisticsParams,
