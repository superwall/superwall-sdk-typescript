...
export class WebhookEndpoints extends APIResource {
  ...
  create(
    ...
    return this._client.post(path`/dash-api/v2/projects/${projectID}/webhook_endpoints`, {
      body,
      ...options,
    });
  }
  ...
  retrieve(
    ...
    return this._client.get(
      path`/dash-api/v2/projects/${project_id}/webhook_endpoints/${endpointID}`,
      options,
    );
  }
  ...
  update(
    ...
    return this._client.patch(path`/dash-api/v2/projects/${project_id}/webhook_endpoints/${endpointID}`, {
      body,
      ...options,
    });
  }
  ...
  list(
    ...
    return this._client.get(path`/dash-api/v2/projects/${projectID}/webhook_endpoints`, {
      query,
      ...options,
    });
  }
  ...
  rotateSecret(
    ...
    return this._client.post(
      path`/dash-api/v2/projects/${project_id}/webhook_endpoints/${endpointID}/rotate_secret`,
      options,
    );
  }
}
