...
import {
  ...
  ApplicationRetrieveRecentTransactionsParams,
  ApplicationRetrieveRecentTransactionsResponse,
  ApplicationRetrieveStatisticsParams,
...
import {
  EventListParams,
  EventListResponse,
  EventRetrieveAttemptsParams,
  EventRetrieveAttemptsResponse,
  EventRetrieveParams,
...
export class Projects extends APIResource {
  ...
  create(body: ProjectCreateParams, options?: RequestOptions): APIPromise<ProjectCreateResponse> {
    return this._client.post('/dash-api/v2/projects', { body, ...options });
  }
  ...
  retrieve(id: string, options?: RequestOptions): APIPromise<ProjectRetrieveResponse> {
    return this._client.get(path`/dash-api/v2/projects/${id}`, options);
  }
  ...
  update(id: string, body: ProjectUpdateParams, options?: RequestOptions): APIPromise<ProjectUpdateResponse> {
    return this._client.patch(path`/dash-api/v2/projects/${id}`, { body, ...options });
  }
  ...
  list(
    ...
    return this._client.get('/dash-api/v2/projects', { query, ...options });
  }
  ...
  archive(id: string, options?: RequestOptions): APIPromise<ProjectArchiveResponse> {
    return this._client.post(path`/dash-api/v2/projects/${id}/archive`, options);
  }
  ...
  unarchive(id: string, options?: RequestOptions): APIPromise<ProjectUnarchiveResponse> {
    return this._client.post(path`/dash-api/v2/projects/${id}/unarchive`, options);
  }
}
