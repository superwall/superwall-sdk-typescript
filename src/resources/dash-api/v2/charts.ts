...
export class Charts extends APIResource {
   ...
   * scope.
   */
  data(body: ChartDataParams, options?: RequestOptions): APIPromise<ChartDataResponse> {
    return this._client.post('/dash-api/v2/charts/data', { body, ...options });
  }
   ...
   */
  retrieveDefinitions(
    query: ChartRetrieveDefinitionsParams,
    options?: RequestOptions,
  ): APIPromise<ChartRetrieveDefinitionsResponse> {
    return this._client.get('/dash-api/v2/charts/definitions', { query, ...options });
  }
}
...
export interface ChartDataResponse {
   ...
   */
  breakdowns: Array<ChartDataResponse.Breakdown>;

  /**
   * Chart data points
   */
  data: Array<ChartDataResponse.Data>;

  /**
   * Date filter definitions
   */
  date_filters: Array<ChartDataResponse.DateFilter>;

  /**
   * Request timing information
   */
  duration: ChartDataResponse.Duration;
   ...
   * Available filters
   */
  filters: Array<ChartDataResponse.Filter>;
   ...
   */
  series: Array<ChartDataResponse.Series>;

  /**
   * X-axis definition
   */
  x_axis: ChartDataResponse.XAxis;

  /**
   * Y-axis definition
   */
  y_axis: ChartDataResponse.YAxis;
}
...
export interface ChartRetrieveDefinitionsResponse {
  /**
   * Available breakdown dimensions
   */
  breakdowns: Array<ChartRetrieveDefinitionsResponse.Breakdown>;

  /**
   * Available chart types
   */
  chart_types: Array<ChartRetrieveDefinitionsResponse.ChartType>;

  /**
   * Available date intervals
   */
  date_intervals: Array<ChartRetrieveDefinitionsResponse.DateInterval>;
   ...
   * Available filters
   */
  filters: Array<ChartRetrieveDefinitionsResponse.Filter>;
   ...
   */
  x_axis: Array<ChartRetrieveDefinitionsResponse.XAxi>;

  /**
   * Available y-axis metrics
   */
  y_axis: Array<ChartRetrieveDefinitionsResponse.YAxi>;
}

export namespace ChartRetrieveDefinitionsResponse {
  export interface Breakdown {
    /**
     * Whether this breakdown is currently active
     */
...
export interface ChartDataParams {
   ...
   */
  date_filter?: ChartDataParams.DateFilter;
...
export namespace ChartDataParams {
  /**
   * Date filter configuration
   */
  export interface DateFilter {
...
export interface ChartRetrieveDefinitionsParams {
  /**
