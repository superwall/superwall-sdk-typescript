...
export class Messages extends APIResource {
  ...
  retrieveAttempts(
    messageID: string,
    params: MessageRetrieveAttemptsParams,
    options?: RequestOptions,
  ): APIPromise<MessageRetrieveAttemptsResponse> {
...
export interface MessageRetrieveAttemptsResponse {
  data: Array<MessageRetrieveAttemptsResponse.Data>;
...
export namespace MessageRetrieveAttemptsResponse {
  export interface Data {
    /**
...
export interface MessageRetrieveAttemptsParams {
  /**
