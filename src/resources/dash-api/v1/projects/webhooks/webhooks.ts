...
import {
  MessageListAttemptsParams,
  MessageListAttemptsResponse,
  MessageListParams,
  MessageListResponse,
  Messages,
} from './messages';
...
export class Webhooks extends APIResource {
   ...
   * given project
   */
  createManagementPortal(
    projectID: string,
    options?: RequestOptions,
  ): APIPromise<WebhookCreateManagementPortalResponse> {
  ...
  getStats(
    endpointID: string,
    params: WebhookGetStatsParams,
    options?: RequestOptions,
  ): APIPromise<WebhookGetStatsResponse> {
  ...
  listAttempts(
    endpointID: string,
    params: WebhookListAttemptsParams,
    options?: RequestOptions,
  ): APIPromise<WebhookListAttemptsResponse> {
    const { projectId, ...query } = params;
...
export interface WebhookCreateManagementPortalResponse {
...
export interface WebhookListAttemptsResponse {
  data: Array<WebhookListAttemptsResponse.Data>;
...
export namespace WebhookListAttemptsResponse {
  export interface Data {
    /**
...
export interface WebhookGetStatsParams {
  /**
   * Path param: a string to be decoded into a number
   */
  projectId: string;
...
export interface WebhookListAttemptsParams {
  /**
   * Path param: a string to be decoded into a number
   */
  projectId: string;
