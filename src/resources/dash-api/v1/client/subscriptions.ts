...
export class Subscriptions extends APIResource {
   ...
   */
  list(playerID: string, options?: RequestOptions): APIPromise<SubscriptionListResponse> {
...
export interface SubscriptionListResponse {
   ...
   */
  subscribedApplications: Array<SubscriptionListResponse.SubscribedApplication>;
}
