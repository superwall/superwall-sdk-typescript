...
import { StatisticGetConfigResponse, Statistics } from './statistics';
...
export declare namespace Charts {
  export { Statistics as Statistics, type StatisticGetConfigResponse as StatisticGetConfigResponse };
}
